...
void DrawOneCar( float bodyColor[3] )
{
	...
	// Draw small body on the top
	glPushMatrix();
	glTranslated(0, 0, CAR_HEIGHT / 4.0*3.0);
	glScaled(CAR_LENGTH / 8.0*5.0, CAR_WIDTH, CAR_HEIGHT / 2.0);
	glutSolidCube(1.0);
	glPopMatrix();
	...
	// Draw the 1st tyre : right-up
	glPushMatrix();
	glTranslated(CAR_LENGTH / 16.0*5.0, CAR_WIDTH / 2.0, CAR_HEIGHT / 4.0);
	glRotated(90, 1, 0, 0);
	glutSolidTorus(CAR_HEIGHT / 8.0, CAR_HEIGHT / 4.0, 100, 100);
	glPopMatrix();

	// Draw the 2nd tyre : left-up
	glPushMatrix();
	glTranslated(-CAR_LENGTH / 16.0*5.0, CAR_WIDTH / 2.0, CAR_HEIGHT / 4.0);
	glRotated(90, 1, 0, 0);
	glutSolidTorus(CAR_HEIGHT / 8.0, CAR_HEIGHT / 4.0, 100, 100);
	...
	// Draw the 3rd tyre : right-bottom
	glPushMatrix();
	glTranslated(CAR_LENGTH / 16.0*5.0, -CAR_WIDTH / 2.0, CAR_HEIGHT / 4.0);
	glRotated(90, 1, 0, 0);
	glutSolidTorus(CAR_HEIGHT / 8.0, CAR_HEIGHT / 4.0, 100, 100);
